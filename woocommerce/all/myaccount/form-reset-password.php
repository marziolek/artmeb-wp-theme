...
<form method="post" class="woocommerce-ResetPassword lost_reset_password">
	...
	<p><?php echo apply_filters( 'woocommerce_reset_password_message', _e( 'Enter a new password below.', 'woocommerce' ) ); ?></p>
	...
	<p class="woocommerce-form-row form-row">
		...
		<input type="submit" class="woocommerce-Button button" value="<?php esc_attr__( 'Save', 'woocommerce' ); ?>" />
	</p>
