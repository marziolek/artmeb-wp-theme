...
echo strtoupper( sprintf( _e( 'Order number: %s', 'woocommerce' ), $order->get_order_number() ) ) . "\n";
...
if ( $sent_to_admin ) {
	echo "\n" . sprintf( _e( 'View order: %s', 'woocommerce' ), admin_url( 'post.php?post=' . $order->get_id() . '&action=edit' ) ) . "\n";
}
