...
<?php endif; ?>
		...
		<form class="woocomerce-form woocommerce-form-login login" method="post">
			...
			<p class="form-row">
				...
				<input type="submit" class="woocommerce-Button button" name="login" value="<?php esc_attr__( 'Login', 'woocommerce' ); ?>" />
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocomerce-FormRow form-row">
				...
				<input type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr__( 'Register', 'woocommerce' ); ?>" />
			</p>
