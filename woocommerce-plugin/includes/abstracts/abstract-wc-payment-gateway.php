...
abstract class WC_Payment_Gateway extends WC_Settings_API {
	...
	public function get_new_payment_method_option_html() {
		$label = apply_filters( 'woocommerce_payment_gateway_get_new_payment_method_option_html_label', $this->new_method_label ? $this->new_method_label : _e( 'Use a new payment method', 'woocommerce' ), $this );
		$html  = sprintf(
	...
	public function save_payment_method_checkbox() {
		printf(
			...
			esc_attr( $this->id ),
			esc_html_e( 'Save to account', 'woocommerce' )
		);
	}
}
