	...
	*/
	...
	public function set_manage_stock( $manage_stock ) {
		...
		if ( true === $manage_stock ) {
			$this->error( 'product_external_invalid_manage_stock', _e( 'External products cannot be stock managed.', 'woocommerce' ) );
		}
	}
	...
	public function set_stock_status( $stock_status = '' ) {
		...
		if ( 'instock' !== $stock_status ) {
			$this->error( 'product_external_invalid_stock_status', _e( 'External products cannot be stock managed.', 'woocommerce' ) );
		}
	}
	...
	public function set_backorders( $backorders ) {
		...
		if ( 'no' !== $backorders ) {
			$this->error( 'product_external_invalid_backorders', _e( 'External products cannot be backordered.', 'woocommerce' ) );
		}
	}
