				...
				if ( $name = wc_attribute_taxonomy_name( $tax->attribute_name ) ) {
					...
					$taxonomy_data                  = array(
						...
						'labels'                => array(
								...
								'singular_name'     => $label,
								'search_items'      => sprintf( _e( 'Search %s', 'woocommerce' ), $label ),
								'all_items'         => sprintf( _e( 'All %s', 'woocommerce' ), $label ),
								'parent_item'       => sprintf( _e( 'Parent %s', 'woocommerce' ), $label ),
								'parent_item_colon' => sprintf( _e( 'Parent %s:', 'woocommerce' ), $label ),
								'edit_item'         => sprintf( _e( 'Edit %s', 'woocommerce' ), $label ),
								'update_item'       => sprintf( _e( 'Update %s', 'woocommerce' ), $label ),
								'add_new_item'      => sprintf( _e( 'Add new %s', 'woocommerce' ), $label ),
								'new_item_name'     => sprintf( _e( 'New %s', 'woocommerce' ), $label ),
								'not_found'         => sprintf( _e( 'No &quot;%s&quot; found', 'woocommerce' ), $label ),
							),
						'show_ui'            => true,
						'show_in_quick_edit' => false,
						'show_in_menu'       => false,
