...
class WC_Helper_Compat {
	...
	public static function admin_menu() {
		...
		add_dashboard_page( _e( 'WooCommerce Helper', 'woocommerce' ), _e( 'WooCommerce Helper', 'woocommerce' ), 'manage_options', 'woothemes-helper', array( __CLASS__, 'render_compat_menu' ) );
	}
