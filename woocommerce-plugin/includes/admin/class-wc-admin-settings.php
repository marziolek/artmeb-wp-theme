...
class WC_Admin_Settings {
	...
	public static function save() {
		...
		if ( empty( $_REQUEST['_wpnonce'] ) || ! wp_verify_nonce( $_REQUEST['_wpnonce'], 'woocommerce-settings' ) ) {
			die( _e( 'Action failed. Please refresh the page and retry.', 'woocommerce' ) );
		}
		...
		self::add_message( _e( 'Your settings have been saved.', 'woocommerce' ) );
			...
			switch ( $value['type'] ) {
				...
				case 'image_width' :
					...
					if ( has_filter( 'woocommerce_get_image_size_' . $image_size ) ) {
						...
						$disabled_message = "<p><small>" . _e( 'The settings of this image size have been disabled because its values are being overwritten by a filter.', 'woocommerce' ) . "</small></p>";
					}
				...
				case 'single_select_country' :
					...
					?><tr valign="top">
						...
						<td class="forminp"><select name="<?php echo esc_attr( $value['id'] ); ?>" style="<?php echo esc_attr( $value['css'] ); ?>" data-placeholder="<?php esc_attr__( 'Choose a country&hellip;', 'woocommerce' ); ?>" aria-label="<?php esc_attr__( 'Country', 'woocommerce' ) ?>" class="wc-enhanced-select">
				...
				case 'multi_select_countries' :
					...
					?><tr valign="top">
						...
						<td class="forminp">
							<select multiple="multiple" name="<?php echo esc_attr( $value['id'] ); ?>[]" style="width:350px" data-placeholder="<?php esc_attr__( 'Choose countries&hellip;', 'woocommerce' ); ?>" aria-label="<?php esc_attr__( 'Country', 'woocommerce' ) ?>" class="wc-enhanced-select">
								<?php
									if ( ! empty( $countries ) ) {
