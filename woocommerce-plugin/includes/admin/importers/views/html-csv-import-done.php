	...
	<section class="woocommerce-importer-done">
		<?php
			...
			if ( 0 < $failed || 0 < $skipped ) {
				$results[] = '<a href="#" class="woocommerce-importer-done-view-errors">' . _e( 'View import log', 'woocommerce' ) . '</a>';
			}

			/* translators: %d: import results */
			echo wp_kses_post( _e( 'Import complete!', 'woocommerce' ) . ' ' . implode( '. ', $results ) );
		?>
	</section>
