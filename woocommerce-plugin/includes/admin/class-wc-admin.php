...
class WC_Admin {
	...
	public function preview_emails() {
		...
		if ( isset( $_GET['preview_woocommerce_mail'] ) ) {
			...
			$email_heading = _e( 'HTML email template', 'woocommerce' );
	...
	public function admin_footer_text( $footer_text ) {
		...
		if ( isset( $current_screen->id ) && apply_filters( 'woocommerce_display_admin_footer_text', in_array( $current_screen->id, $wc_pages ) ) ) {
			...
			if ( ! get_option( 'woocommerce_admin_footer_text_rated' ) ) {
				...
				$footer_text = sprintf( _e( 'If you like <strong>WooCommerce</strong> please leave us a %s rating. A huge thanks in advance!', 'woocommerce' ), '<a href="https://wordpress.org/support/plugin/woocommerce/reviews?rate=5#new-post" target="_blank" class="wc-rating-link" data-rated="' . esc_attr__( 'Thanks :)', 'woocommerce' ) . '">&#9733;&#9733;&#9733;&#9733;&#9733;</a>' );
				wc_enqueue_js( "
				...
				$footer_text = _e( 'Thank you for selling with WooCommerce.', 'woocommerce' );
			}
		}
