	...
	<div id="woocommerce-fields-bulk" class="inline-edit-col">
		...
		<label>
			...
			<span class="input-text-wrap">
				...
				<?php
					echo '<option value="">' . esc_html_e( '— No Change —', 'woocommerce' ) . '</option>';
		...
		<?php if ( 'yes' == get_option( 'woocommerce_manage_stock' ) ) : ?>
			...
			<div class="inline-edit-group">
				...
				<label class="change-input">
					<input type="text" name="_stock" class="text stock" placeholder="<?php esc_attr__( 'Stock qty', 'woocommerce' ); ?>" step="any" value="">
				</label>
			</div>
