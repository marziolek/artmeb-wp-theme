...
class WC_Admin_Menus {
	...
	public function admin_menu() {
		...
		add_menu_page( _e( 'WooCommerce', 'woocommerce' ), _e( 'WooCommerce', 'woocommerce' ), 'manage_woocommerce', 'woocommerce', null, null, '55.5' );

		add_submenu_page( 'edit.php?post_type=product', _e( 'Attributes', 'woocommerce' ), _e( 'Attributes', 'woocommerce' ), 'manage_product_terms', 'product_attributes', array( $this, 'attributes_page' ) );
	}
	...
	public function reports_menu() {
		if ( current_user_can( 'manage_woocommerce' ) ) {
			add_submenu_page( 'woocommerce', _e( 'Reports', 'woocommerce' ),  _e( 'Reports', 'woocommerce' ) , 'view_woocommerce_reports', 'wc-reports', array( $this, 'reports_page' ) );
		} else {
			add_menu_page( _e( 'Sales reports', 'woocommerce' ),  _e( 'Sales reports', 'woocommerce' ) , 'view_woocommerce_reports', 'wc-reports', array( $this, 'reports_page' ), null, '55.6' );
		}
	}
	...
	public function settings_menu() {
		$settings_page = add_submenu_page( 'woocommerce', _e( 'WooCommerce settings', 'woocommerce' ),  _e( 'Settings', 'woocommerce' ) , 'manage_woocommerce', 'wc-settings', array( $this, 'settings_page' ) );
	...
	public function status_menu() {
		add_submenu_page( 'woocommerce', _e( 'WooCommerce status', 'woocommerce' ),  _e( 'Status', 'woocommerce' ) , 'manage_woocommerce', 'wc-status', array( $this, 'status_page' ) );
	}
	...
	public function addons_menu() {
		add_submenu_page( 'woocommerce', _e( 'WooCommerce extensions', 'woocommerce' ),  _e( 'Extensions', 'woocommerce' ) , 'manage_woocommerce', 'wc-addons', array( $this, 'addons_page' ) );
	}
	...
	public function add_nav_menu_meta_boxes() {
		add_meta_box( 'woocommerce_endpoints_nav_link', _e( 'WooCommerce endpoints', 'woocommerce' ), array( $this, 'nav_menu_links' ), 'nav-menus', 'side', 'low' );
	}
	...
	public function nav_menu_links() {
		...
		$endpoints['lost-password'] = _e( 'Lost password', 'woocommerce' );
		...
		<div id="posttype-woocommerce-endpoints" class="posttypediv">
			...
			<p class="button-controls">
				...
				<span class="add-to-menu">
					<input type="submit" class="button-secondary submit-add-to-menu right" value="<?php esc_attr__( 'Add to menu', 'woocommerce' ); ?>" name="add-post-type-menu-item" id="submit-posttype-woocommerce-endpoints">
