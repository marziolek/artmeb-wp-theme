...
class WC_Admin_Taxonomies {
	...
	public function product_cat_description() {
		echo wpautop( _e( 'Product categories for your store can be managed here. To change the order of categories on the front-end you can drag and drop to sort them. To see more categories listed click the "screen options" link at the top-right of this page.', 'woocommerce' ) );
	}
	...
	public function product_attribute_description() {
		echo wpautop( _e( 'Attribute terms can be assigned to products and variations.<br/><br/><b>Note</b>: Deleting a term will remove it from all products and variations to which it has been assigned. Recreating a term will not automatically assign it back to products.', 'woocommerce' ) );
	}
	...
	public function product_cat_columns( $columns ) {
		...
		$new_columns['thumb'] = _e( 'Image', 'woocommerce' );
