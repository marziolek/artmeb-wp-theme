...
class WC_Admin_Importers {
	...
	public function register_importers() {
		if ( defined( 'WP_LOAD_IMPORTERS' ) ) {
			...
			register_importer( 'woocommerce_product_csv',  _e( 'WooCommerce products (CSV)', 'woocommerce' ),  _e( 'Import <strong>products</strong> to your store via a csv file.', 'woocommerce' ),  array( $this, 'product_importer' ) );
			register_importer( 'woocommerce_tax_rate_csv', _e( 'WooCommerce tax rates (CSV)', 'woocommerce' ), _e( 'Import <strong>tax rates</strong> to your store via a csv file.', 'woocommerce' ), array( $this, 'tax_rates_importer' ) );
		}
	}
