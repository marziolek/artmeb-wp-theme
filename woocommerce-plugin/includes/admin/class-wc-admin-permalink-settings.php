...
class WC_Admin_Permalink_Settings {
	...
	public function settings_init() {
		...
		add_settings_section( 'woocommerce-permalink', _e( 'Product permalinks', 'woocommerce' ), array( $this, 'settings' ), 'permalink' );

		// Add our settings
		add_settings_field(
			'woocommerce_product_category_slug',            // id
			_e( 'Product category base', 'woocommerce' ),   // setting title
		...
		add_settings_field(
			...
			_e( 'Product tag base', 'woocommerce' ),        // setting title
		...
		add_settings_field(
			...
			_e( 'Product attribute base', 'woocommerce' ),  // setting title
	...
	public function settings() {
		echo wpautop( _e( 'These settings control the permalinks used specifically for products.', 'woocommerce' ) );
