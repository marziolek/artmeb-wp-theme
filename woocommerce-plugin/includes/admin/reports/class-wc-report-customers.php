...
class WC_Report_Customers extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			...
			'title' => sprintf( _e( '%s signups in this period', 'woocommerce' ), '<strong>' . sizeof( $this->customers ) . '</strong>' ),
 				...
 				jQuery.plot(
					...
					],
					{
						...
						series: {
							...
							enable_tooltip: true,
							append_tooltip: "<?php echo ' ' . _e( 'orders', 'woocommerce' ); ?>",
						},
						legend: {
							show: false
						}
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
							{
								label: "<?php echo esc_js( _e( 'Customer orders', 'woocommerce' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . _e( 'customer orders', 'woocommerce' ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( _e( 'Guest orders', 'woocommerce' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . _e( 'guest orders', 'woocommerce' ); ?>",
								stack: true,
							},
							{
								label: "<?php echo esc_js( _e( 'Signups', 'woocommerce' ) ) ?>",
								...
								shadowSize: 0,
								enable_tooltip: true,
								append_tooltip: "<?php echo ' ' . _e( 'new users', 'woocommerce' ); ?>",
								stack: false
							},
						];
