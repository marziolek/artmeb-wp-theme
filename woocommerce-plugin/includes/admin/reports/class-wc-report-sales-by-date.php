...
class WC_Report_Sales_By_Date extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		switch ( $this->chart_groupby ) {
			case 'day' :
				...
				$average_total_sales_title = sprintf(
					_e( '%s average gross daily sales', 'woocommerce' ),
					'<strong>' . wc_price( $data->average_total_sales ) . '</strong>'
				);
				/* translators: %s: average sales */
				$average_sales_title = sprintf(
					_e( '%s average net daily sales', 'woocommerce' ),
			...
			default :
				/* translators: %s: average total sales */
				$average_total_sales_title = sprintf(
					_e( '%s average gross monthly sales', 'woocommerce' ),
					'<strong>' . wc_price( $data->average_total_sales ) . '</strong>'
				);
				/* translators: %s: average sales */
				$average_sales_title = sprintf(
					_e( '%s average net monthly sales', 'woocommerce' ),
					'<strong>' . wc_price( $data->average_sales ) . '</strong>'
				);
			break;
		}
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s gross sales in this period', 'woocommerce' ),
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s net sales in this period', 'woocommerce' ),
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s orders placed', 'woocommerce' ),
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s items purchased', 'woocommerce' ),
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s charged for shipping', 'woocommerce' ),
		...
		$legend[] = array(
			...
			'title' => sprintf(
				_e( '%s worth of coupons used', 'woocommerce' ),
	...
	public function get_export_button() {
		...
		<a
			...
			class="export_csv"
			data-export="chart"
			data-xaxes="<?php esc_attr__( 'Date', 'woocommerce' ); ?>"
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( _e( 'Number of items sold', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Number of orders', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Average gross sales amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Average net sales amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Coupon amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Shipping amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Gross sales amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Net sales amount', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Refund amount', 'woocommerce' ) ) ?>",
