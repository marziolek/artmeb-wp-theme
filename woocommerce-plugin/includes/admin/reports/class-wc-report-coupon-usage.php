...
class WC_Report_Coupon_Usage extends WC_Admin_Report {
	...
	public function get_chart_legend() {
		...
		$legend[] = array(
			...
			'title' => sprintf( _e( '%s discounts in total', 'woocommerce' ), '<strong>' . wc_price( $total_discount ) . '</strong>' ),
		...
		$legend[] = array(
			...
			'title' => sprintf( _e( '%s coupons used in total', 'woocommerce' ), '<strong>' . $total_coupons . '</strong>' ),
		...
		<div class="section">
			<form method="GET">
				<div>
					...
					?>
						<select id="coupon_codes" name="coupon_codes" class="wc-enhanced-select" data-placeholder="<?php esc_attr__( 'Choose coupons&hellip;', 'woocommerce' ); ?>" style="width:100%;">
		...
		<div class="section">
			<table cellspacing="0">
				...
				if ( ! empty( $most_popular ) && is_array( $most_popular ) ) {
					...
					echo '<tr><td colspan="2">' . _e( 'No coupons found in range', 'woocommerce' ) . '</td></tr>';
				}
				?>
			</table>
		</div>
		...
		<div class="section">
			<table cellspacing="0">
				...
				if ( ! empty( $most_discount ) && is_array( $most_discount ) ) {
					...
					echo '<tr><td colspan="3">' . _e( 'No coupons found in range', 'woocommerce' ) . '</td></tr>';
				}
				?>
			</table>
		</div>
		...
		<script type="text/javascript">
			...
			jQuery(function(){
				...
				var drawGraph = function( highlight ) {
					var series = [
						{
							label: "<?php echo esc_js( _e( 'Number of coupons used', 'woocommerce' ) ) ?>",
						...
						{
							label: "<?php echo esc_js( _e( 'Discount amount', 'woocommerce' ) ) ?>",
