...
<h2>
	...
	<span class="wc-shipping-zone-name"><?php echo esc_html( $zone->get_zone_name() ? $zone->get_zone_name() : _e( 'Zone', 'woocommerce' ) ); ?></span>
</h2>
	...
	<tbody>
		<?php if ( 0 !== $zone->get_id() ) : ?>
			<tr valign="top" class="">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_help_tip( _e( 'This is the name of the zone for your reference.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top" class="">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_help_tip( _e( 'These are regions inside this zone. Customers will be matched against these regions.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
					...
					<div class="wc-shipping-zone-postcodes">
						<textarea name="zone_postcodes" data-attribute="zone_postcodes" id="zone_postcodes" placeholder="<?php esc_attr__( 'List 1 postcode per line', 'woocommerce' ); ?>" class="input-text large-text" cols="25" rows="5"><?php echo esc_textarea( implode( "\n", $postcodes ) ); ?></textarea>
		...
		<tr valign="top" class="">
			<th scope="row" class="titledesc">
				...
				<?php echo wc_help_tip( _e( 'The following shipping methods apply to customers with shipping addresses within this zone.', 'woocommerce' ) ); ?>
			</th>
			<td class="">
				<table class="wc-shipping-zone-methods widefat">
					...
					<tfoot>
						<tr>
							<td colspan="4">
								<input type="submit" class="button wc-shipping-zone-add-method" value="<?php esc_attr__( 'Add shipping method', 'woocommerce' ); ?>" />
							</td>
						</tr>
					</tfoot>
...
<p class="submit">
	<input type="submit" name="submit" id="submit" class="button button-primary button-large wc-shipping-zone-method-save" value="<?php esc_attr__( 'Save changes', 'woocommerce' ); ?>" disabled />
</p>
			...
			<section class="wc-backbone-modal-main" role="main">
				<header class="wc-backbone-modal-header">
					<h1><?php
						...
						printf(
							esc_html_e( '%s Settings', 'woocommerce' ),
