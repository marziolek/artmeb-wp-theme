...
<div id="key-fields" class="settings-panel">
		...
		<tbody>
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_help_tip( _e( 'Friendly name for identifying this key.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_help_tip( _e( 'Owner of these keys.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
					<?php
					...
					?>
					<select class="wc-customer-search" id="key_user" data-placeholder="<?php esc_attr__( 'Search for a user&hellip;', 'woocommerce' ); ?>" data-allow_clear="true">
			...
			<tr valign="top">
				<th scope="row" class="titledesc">
					...
					<?php echo wc_help_tip( _e( 'Select the access type of these keys.', 'woocommerce' ) ); ?>
				</th>
				<td class="forminp">
					...
					<td class="forminp">
						<span><?php
							if ( ! empty( $key_data['last_access'] ) ) {
								...
								$date = sprintf( _e( '%1$s at %2$s', 'woocommerce' ), date_i18n( wc_date_format(), strtotime( $key_data['last_access'] ) ), date_i18n( wc_time_format(), strtotime( $key_data['last_access'] ) ) );
	...
	<?php
		if ( 0 == $key_id ) {
			submit_button( _e( 'Generate API key', 'woocommerce' ), 'primary', 'update_api_key' );
		} else {
			?>
			<p class="submit">
				<?php submit_button( _e( 'Save changes', 'woocommerce' ), 'primary', 'update_api_key', false ); ?>
	...
	<table class="form-table">
		<tbody>
			<tr valign="top">
				...
				<td class="forminp">
					<input id="key_consumer_key" type="text" value="{{ data.consumer_key }}" size="55" readonly="readonly"> <button type="button" class="button-secondary copy-key" data-tip="<?php esc_attr__( 'Copied!', 'woocommerce' ); ?>"><?php _e( 'Copy', 'woocommerce' ); ?></button>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
				...
				<td class="forminp">
					<input id="key_consumer_secret" type="text" value="{{ data.consumer_secret }}" size="55" readonly="readonly"> <button type="button" class="button-secondary copy-secret" data-tip="<?php esc_attr__( 'Copied!', 'woocommerce' ); ?>"><?php _e( 'Copy', 'woocommerce' ); ?></button>
				</td>
			</tr>
			<tr valign="top">
				<th scope="row" class="titledesc">
