...
class WC_Settings_Accounts extends WC_Settings_Page {
	...
	public function __construct() {
		...
		$this->id    = 'account';
		$this->label = _e( 'Accounts', 'woocommerce' );
	...
	public function get_settings() {
		$settings = apply_filters( 'woocommerce_' . $this->id . '_settings', array(
			...
			array(
				...
				'desc'     => sprintf( _e( 'Page contents: [%s]', 'woocommerce' ), apply_filters( 'woocommerce_my_account_shortcode_tag', 'woocommerce_my_account' ) ),
