	...
	<div class="options_group pricing show_if_simple show_if_external hidden">
		<?php
			...
			woocommerce_wp_text_input( array(
				...
				'description' => '<a href="#" class="sale_schedule">' . _e( 'Schedule', 'woocommerce' ) . '</a>',
			) );
			...
			echo '<p class="form-field sale_price_dates_fields">
					<label for="_sale_price_dates_from">' . _e( 'Sale price dates', 'woocommerce' ) . '</label>
					...
					<a href="#" class="description cancel_sale_schedule">' . _e( 'Cancel', 'woocommerce' ) . '</a>' . wc_help_tip( _e( 'The sale will end at the beginning of the set date.', 'woocommerce' ) ) . '
				</p>';
