		...
		<?php else : ?>
			...
			<div class="toolbar toolbar-variations-defaults">
				<div class="variations-defaults">
					<strong><?php _e( 'Default Form Values', 'woocommerce' ); ?>: <?php echo wc_help_tip( _e( 'These are the attributes that will be pre-selected on the frontend.', 'woocommerce' ) ); ?></strong>
					<?php
						foreach ( $variation_attributes as $attribute ) {
							...
							<select name="default_attribute_<?php echo sanitize_title( $attribute->get_name() ); ?>" data-current="<?php echo esc_attr( $selected_value ); ?>">
								<option value=""><?php printf( esc_html_e( 'No default %s&hellip;', 'woocommerce' ), wc_attribute_label( $attribute->get_name() ) ); ?></option>
			...
			<div class="toolbar toolbar-top">
				<select id="field_to_edit" class="variation_actions">
					...
					<optgroup label="<?php esc_attr__( 'Status', 'woocommerce' ); ?>">
					...
					<optgroup label="<?php esc_attr__( 'Pricing', 'woocommerce' ); ?>">
					...
					<optgroup label="<?php esc_attr__( 'Inventory', 'woocommerce' ); ?>">
					...
					<optgroup label="<?php esc_attr__( 'Shipping', 'woocommerce' ); ?>">
					...
					<optgroup label="<?php esc_attr__( 'Downloadable products', 'woocommerce' ); ?>">
				...
				<div class="variations-pagenav">
					...
					<span class="pagination-links">
						<a class="first-page disabled" title="<?php esc_attr__( 'Go to the first page', 'woocommerce' ); ?>" href="#">&laquo;</a>
						<a class="prev-page disabled" title="<?php esc_attr__( 'Go to the previous page', 'woocommerce' ); ?>" href="#">&lsaquo;</a>
						<span class="paging-select">
							<label for="current-page-selector-1" class="screen-reader-text"><?php _e( 'Select Page', 'woocommerce' ); ?></label>
							<select class="page-selector" id="current-page-selector-1" title="<?php esc_attr__( 'Current page', 'woocommerce' ); ?>">
						...
						<a class="next-page" title="<?php esc_attr__( 'Go to the next page', 'woocommerce' ); ?>" href="#">&rsaquo;</a>
						<a class="last-page" title="<?php esc_attr__( 'Go to the last page', 'woocommerce' ); ?>" href="#">&raquo;</a>
					</span>
				</div>
				<div class="clear"></div>
			</div>
