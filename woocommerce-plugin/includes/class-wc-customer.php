	...
	*/
	...
	public function set_email( $value ) {
		if ( $value && ! is_email( $value ) ) {
			$this->error( 'customer_invalid_email', _e( 'Invalid email address', 'woocommerce' ) );
		}
	...
	public function set_role( $role ) {
		...
		if ( $role && ! empty( $wp_roles->roles ) && ! in_array( $role, array_keys( $wp_roles->roles ) ) ) {
			$this->error( 'customer_invalid_role', _e( 'Invalid role', 'woocommerce' ) );
		}
	...
	public function set_billing_email( $value ) {
		if ( $value && ! is_email( $value ) ) {
			$this->error( 'customer_invalid_billing_email', _e( 'Invalid billing email address', 'woocommerce' ) );
		}
