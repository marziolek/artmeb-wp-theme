...
class WC_Email_Customer_On_Hold_Order extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = _e( 'Order on-hold', 'woocommerce' );
		$this->description      = _e( 'This is an order notification sent to customers containing order details after an order is placed on-hold.', 'woocommerce' );
	...
	public function get_default_subject() {
		return _e( 'Your {site_title} order receipt from {order_date}', 'woocommerce' );
	}
	...
	public function get_default_heading() {
		return _e( 'Thank you for your order', 'woocommerce' );
	}
