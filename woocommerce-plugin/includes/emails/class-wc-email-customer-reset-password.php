...
class WC_Email_Customer_Reset_Password extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = _e( 'Reset password', 'woocommerce' );
		$this->description      = _e( 'Customer "reset password" emails are sent when customers reset their passwords.', 'woocommerce' );
	...
	public function get_default_subject() {
		return _e( 'Password reset for {site_title}', 'woocommerce' );
	}
	...
	public function get_default_heading() {
		return _e( 'Password reset instructions', 'woocommerce' );
	}
