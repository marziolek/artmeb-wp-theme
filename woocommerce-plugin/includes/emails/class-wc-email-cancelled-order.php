...
class WC_Email_Cancelled_Order extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = _e( 'Cancelled order', 'woocommerce' );
		$this->description      = _e( 'Cancelled order emails are sent to chosen recipient(s) when orders have been marked cancelled (if they were previously processing or on-hold).', 'woocommerce' );
	...
	public function get_default_subject() {
		return _e( '[{site_title}] Cancelled order ({order_number})', 'woocommerce' );
	}
	...
	public function get_default_heading() {
		return _e( 'Cancelled order', 'woocommerce' );
	}
	...
	public function init_form_fields() {
		$this->form_fields = array(
			...
			'recipient' => array(
				...
				'description'   => sprintf( _e( 'Enter recipients (comma separated) for this email. Defaults to %s.', 'woocommerce' ), '<code>' . esc_attr( get_option( 'admin_email' ) ) . '</code>' ),
				'placeholder'   => '',
				'default'       => '',
				'desc_tip'      => true,
			),
