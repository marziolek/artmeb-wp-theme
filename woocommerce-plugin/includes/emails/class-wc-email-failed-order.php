...
class WC_Email_Failed_Order extends WC_Email {
	...
	public function __construct() {
		...
		$this->title            = _e( 'Failed order', 'woocommerce' );
		$this->description      = _e( 'Failed order emails are sent to chosen recipient(s) when orders have been marked failed (if they were previously processing or on-hold).', 'woocommerce' );
	...
	public function get_default_subject() {
		return _e( '[{site_title}] Failed order ({order_number})', 'woocommerce' );
	}
	...
	public function get_default_heading() {
		return _e( 'Failed order', 'woocommerce' );
	}
