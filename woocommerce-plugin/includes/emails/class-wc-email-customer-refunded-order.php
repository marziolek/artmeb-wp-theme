...
class WC_Email_Customer_Refunded_Order extends WC_Email {
	...
	public function __construct() {
		...
		$this->title          = _e( 'Refunded order', 'woocommerce' );
		$this->description    = _e( 'Order refunded emails are sent to customers when their orders are refunded.', 'woocommerce' );
	...
	public function get_default_subject( $partial = false ) {
		if ( $partial ) {
			return _e( 'Your {site_title} order from {order_date} has been partially refunded', 'woocommerce' );
		} else {
			return _e( 'Your {site_title} order from {order_date} has been refunded', 'woocommerce' );
		}
	}
	...
	public function get_default_heading( $partial = false ) {
		if ( $partial ) {
			...
			return _e( 'Your order has been partially refunded', 'woocommerce' );
		}
	}
