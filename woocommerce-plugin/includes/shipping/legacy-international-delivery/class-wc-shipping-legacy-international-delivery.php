...
class WC_Shipping_Legacy_International_Delivery extends WC_Shipping_Legacy_Flat_Rate {
	...
	public function __construct() {
		...
		$this->method_title       = _e( 'International flat rate (legacy)', 'woocommerce' );
		$this->method_description = '<strong>' . sprintf( _e( 'This method is deprecated in 2.6.0 and will be removed in future versions - we recommend disabling it and instead setting up a new rate within your <a href="%s">Shipping zones</a>.', 'woocommerce' ), admin_url( 'admin.php?page=wc-settings&tab=shipping' ) ) . '</strong>';
		$this->init();
