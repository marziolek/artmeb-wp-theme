...
class WC_Shipping_Local_Pickup extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title          = _e( 'Local pickup', 'woocommerce' );
		$this->method_description    = _e( 'Allow customers to pick up orders themselves. By default, when using local pickup store base taxes will apply regardless of customer address.', 'woocommerce' );
		$this->supports              = array(
			'shipping-zones',
			'instance-settings',
