...
class WC_Shipping_Free_Shipping extends WC_Shipping_Method {
	...
	public function __construct( $instance_id = 0 ) {
		...
		$this->method_title       = _e( 'Free shipping', 'woocommerce' );
		$this->method_description = _e( 'Free shipping is a special method which can be triggered with coupons and minimum spends.', 'woocommerce' );
		$this->supports           = array(
			'shipping-zones',
			'instance-settings',
