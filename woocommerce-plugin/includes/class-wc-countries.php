...
class WC_Countries {
	...
	public function shipping_to_prefix( $country_code = '' ) {
		...
		$return       = in_array( $country_code, $countries ) ? _e( 'to the', 'woocommerce' ) : _e( 'to', 'woocommerce' );
	...
	public function estimated_for_prefix( $country_code = '' ) {
		...
		$countries    = array( 'GB', 'US', 'AE', 'CZ', 'DO', 'NL', 'PH', 'USAF' );
		$return       = in_array( $country_code, $countries ) ? _e( 'the', 'woocommerce' ) . ' ' : '';
	...
	public function tax_or_vat() {
		$return = in_array( $this->get_base_country(), array_merge( $this->get_european_union_countries( 'eu_vat' ), array( 'NO' ) ) ) ? _e( 'VAT', 'woocommerce' ) : _e( 'Tax', 'woocommerce' );
	...
	public function inc_tax_or_vat() {
		$return = in_array( $this->get_base_country(), array_merge( $this->get_european_union_countries( 'eu_vat' ), array( 'NO' ) ) ) ? _e( '(incl. VAT)', 'woocommerce' ) : _e( '(incl. tax)', 'woocommerce' );
	...
	public function ex_tax_or_vat() {
		$return = in_array( $this->get_base_country(), array_merge( $this->get_european_union_countries( 'eu_vat' ), array( 'NO' ) ) ) ? _e( '(ex. VAT)', 'woocommerce' ) : _e( '(ex. tax)', 'woocommerce' );
