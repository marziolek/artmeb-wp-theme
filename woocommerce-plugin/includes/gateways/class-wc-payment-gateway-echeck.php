	...
	public function form() {
		...
		$default_fields = array(
			'routing-number' => '<p class="form-row form-row-first">
				<label for="' . esc_attr( $this->id ) . '-routing-number">' . esc_html_e( 'Routing number', 'woocommerce' ) . ' <span class="required">*</span></label>
			...
			'account-number' => '<p class="form-row form-row-wide">
				<label for="' . esc_attr( $this->id ) . '-account-number">' . esc_html_e( 'Account number', 'woocommerce' ) . ' <span class="required">*</span></label>
