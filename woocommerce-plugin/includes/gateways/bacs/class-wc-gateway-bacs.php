...
class WC_Gateway_BACS extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_title       = _e( 'BACS', 'woocommerce' );
		$this->method_description = _e( 'Allows payments by BACS, more commonly known as direct bank/wire transfer.', 'woocommerce' );
	...
	public function generate_account_details_html() {
		...
		$sortcode = isset( $locale[ $country ]['sortcode']['label'] ) ? $locale[ $country ]['sortcode']['label'] : _e( 'Sort code', 'woocommerce' );
	...
	private function bank_details( $order_id = '' ) {
		...
		if ( ! empty( $bacs_accounts ) ) {
			...
			if ( $has_details ) {
				echo '<section class="woocommerce-bacs-bank-details"><h2 class="wc-bacs-bank-details-heading">' . _e( 'Our bank details', 'woocommerce' ) . '</h2>' . PHP_EOL . $account_html . '</section>';
			}
		}
	...
	public function process_payment( $order_id ) {
		...
		$order->update_status( 'on-hold', _e( 'Awaiting BACS payment', 'woocommerce' ) );
