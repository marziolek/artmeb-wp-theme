...
return array(
	...
	'testmode' => array(
		...
		'default'     => 'no',
		'description' => sprintf( _e( 'PayPal sandbox can be used to test payments. Sign up for a <a href="%s">developer account</a>.', 'woocommerce' ), 'https://developer.paypal.com/' ),
	),
	'debug' => array(
		...
		'default'     => 'no',
		'description' => sprintf( _e( 'Log PayPal events, such as IPN requests, inside %s', 'woocommerce' ), '<code>' . WC_Log_Handler_File::get_log_file_path( 'paypal' ) . '</code>' ),
	),
	'advanced' => array(
	...
	'api_details' => array(
		...
		'type'        => 'title',
		'description' => sprintf( _e( 'Enter your PayPal API credentials to process refunds via PayPal. Learn how to access your <a href="%s">PayPal API Credentials</a>.', 'woocommerce' ), 'https://developer.paypal.com/webapps/developer/docs/classic/api/apiCredentials/#creating-an-api-signature' ),
	),
	'api_username' => array(
