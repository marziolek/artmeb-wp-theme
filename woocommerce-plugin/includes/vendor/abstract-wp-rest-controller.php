...
abstract class WP_REST_Controller {
	...
	public function register_routes() {
		wc_doing_it_wrong( 'WP_REST_Controller::register_routes', _e( 'The register_routes() method must be overriden', 'woocommerce' ), 'WPAPI-2.0' );
	}
	...
	public function get_items_permissions_check( $request ) {
		return new WP_Error( 'invalid-method', sprintf( _e( "Method '%s' not implemented. Must be over-ridden in subclass.", 'woocommerce' ), __METHOD__ ), array( 'status' => 405 ) );
	}
