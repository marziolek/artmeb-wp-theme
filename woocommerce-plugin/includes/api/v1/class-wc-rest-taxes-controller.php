...
class WC_REST_Taxes_V1_Controller extends WC_REST_Controller {
	...
	public function create_item( $request ) {
		if ( ! empty( $request['id'] ) ) {
			return new WP_Error( 'woocommerce_rest_tax_exists', _e( 'Cannot create existing resource.', 'woocommerce' ), array( 'status' => 400 ) );
		}
	...
	public function delete_item( $request ) {
		...
		if ( ! $force ) {
			return new WP_Error( 'woocommerce_rest_trash_not_supported', _e( 'Taxes do not support trashing.', 'woocommerce' ), array( 'status' => 501 ) );
		}
