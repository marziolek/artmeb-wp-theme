...
class WC_REST_Products_V1_Controller extends WC_REST_Posts_Controller {
		...
		if ( is_array( $images ) ) {
			...
			foreach ( $images as $image ) {
				...
				if ( ! wp_attachment_is_image( $attachment_id ) ) {
					throw new WC_REST_Exception( 'woocommerce_product_invalid_image_id', sprintf( _e( '#%s is an invalid image ID.', 'woocommerce' ), $attachment_id ), 400 );
				}
	...
	public function delete_item( $request ) {
		...
		if ( ! empty( $post->post_type ) && 'product_variation' === $post->post_type && 'product' === $this->post_type ) {
			...
			return new WP_Error( "woocommerce_rest_{$this->post_type}_invalid_id", _e( 'Invalid post ID.', 'woocommerce' ), array( 'status' => 404 ) );
		}
		...
		$schema         = array(
			...
			'properties' => array(
				...
				'weight' => array(
					...
					'description' => sprintf( _e( 'Product weight (%s).', 'woocommerce' ), $weight_unit ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'dimensions' => array(
					...
					'properties'  => array(
						'length' => array(
							...
							'description' => sprintf( _e( 'Product length (%s).', 'woocommerce' ), $dimension_unit ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'width' => array(
							/* translators: %s: dimension unit */
							'description' => sprintf( _e( 'Product width (%s).', 'woocommerce' ), $dimension_unit ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
						'height' => array(
							/* translators: %s: dimension unit */
							'description' => sprintf( _e( 'Product height (%s).', 'woocommerce' ), $dimension_unit ),
							'type'        => 'string',
							'context'     => array( 'view', 'edit' ),
						),
					),
				...
				'variations' => array(
					...
					'items'       => array(
						...
						'properties' => array(
							...
							'weight' => array(
								/* translators: %s: weight unit */
								'description' => sprintf( _e( 'Variation weight (%s).', 'woocommerce' ), $weight_unit ),
								'type'        => 'string',
								'context'     => array( 'view', 'edit' ),
							),
							'dimensions' => array(
								...
								'properties'  => array(
									'length' => array(
										/* translators: %s: dimension unit */
										'description' => sprintf( _e( 'Variation length (%s).', 'woocommerce' ), $dimension_unit ),
										'type'        => 'string',
										'context'     => array( 'view', 'edit' ),
									),
									'width' => array(
										/* translators: %s: dimension unit */
										'description' => sprintf( _e( 'Variation width (%s).', 'woocommerce' ), $dimension_unit ),
										'type'        => 'string',
										'context'     => array( 'view', 'edit' ),
									),
									'height' => array(
										/* translators: %s: dimension unit */
										'description' => sprintf( _e( 'Variation height (%s).', 'woocommerce' ), $dimension_unit ),
										'type'        => 'string',
										'context'     => array( 'view', 'edit' ),
									),
								),
