	...
	public function get_collection_params() {
		return array(
			...
			'date_min' => array(
				...
				'description'       => sprintf( _e( 'Return sales for a specific start date, the date need to be in the %s format.', 'woocommerce' ), 'YYYY-MM-AA' ),
				'type'              => 'string',
				'format'            => 'date',
			...
			'date_max' => array(
				/* translators: %s: date format */
				'description'       => sprintf( _e( 'Return sales for a specific end date, the date need to be in the %s format.', 'woocommerce' ), 'YYYY-MM-AA' ),
				'type'              => 'string',
				'format'            => 'date',
				'validate_callback' => 'wc_rest_validate_reports_request_arg',
				'sanitize_callback' => 'sanitize_text_field',
