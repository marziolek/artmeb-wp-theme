...
class WC_REST_Shipping_Zone_Locations_Controller extends WC_REST_Shipping_Zones_Controller_Base {
	...
	public function update_items( $request ) {
		...
		if ( 0 === $zone->get_id() ) {
			return new WP_Error( "woocommerce_rest_shipping_zone_locations_invalid_zone", _e( 'The "locations not covered by your other zones" zone cannot be updated.', 'woocommerce' ), array( 'status' => 403 ) );
		}
