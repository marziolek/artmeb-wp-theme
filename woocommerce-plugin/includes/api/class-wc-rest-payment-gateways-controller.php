...
class WC_REST_Payment_Gateways_Controller extends WC_REST_Controller {
	...
	public function get_item( $request ) {
		...
		if ( is_null( $gateway ) ) {
			return new WP_Error( 'woocommerce_rest_payment_gateway_invalid', _e( 'Resource does not exist.', 'woocommerce' ), array( 'status' => 404 ) );
		}
	...
	public function update_item( $request ) {
		...
		if ( isset( $request['settings'] ) ) {
			...
			if ( $errors_found ) {
				return new WP_Error( 'rest_setting_value_invalid', _e( 'An invalid setting value was passed.', 'woocommerce' ), array( 'status' => 400 ) );
			}
		}
