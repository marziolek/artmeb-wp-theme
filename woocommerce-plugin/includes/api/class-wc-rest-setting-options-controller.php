...
class WC_REST_Setting_Options_Controller extends WC_REST_Controller {
	...
	public function get_group_settings( $group_id ) {
		if ( empty( $group_id ) ) {
			return new WP_Error( 'rest_setting_setting_group_invalid', _e( 'Invalid setting group.', 'woocommerce' ), array( 'status' => 404 ) );
		}
	...
	public function get_setting( $group_id, $setting_id ) {
		if ( empty( $setting_id ) ) {
			return new WP_Error( 'rest_setting_setting_invalid', _e( 'Invalid setting.', 'woocommerce' ), array( 'status' => 404 ) );
		}
