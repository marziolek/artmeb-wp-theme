...
class WC_API_Products extends WC_API_Resource {
	...
	public function get_products_count( $type = null, $filter = array() ) {
		...
		if ( ! current_user_can( 'read_private_products' ) ) {
			return new WP_Error( 'woocommerce_api_user_cannot_read_products_count', _e( 'You do not have permission to read the products count', 'woocommerce' ), array( 'status' => 401 ) );
		}
