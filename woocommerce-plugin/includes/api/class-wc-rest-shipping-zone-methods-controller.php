...
class WC_REST_Shipping_Zone_Methods_Controller extends WC_REST_Shipping_Zones_Controller_Base {
	...
	public function get_item( $request ) {
		...
		if ( false === $method ) {
			return new WP_Error( 'woocommerce_rest_shipping_zone_method_invalid', _e( 'Resource does not exist.', 'woocommerce' ), array( 'status' => 404 ) );
		}
	...
	public function create_item( $request ) {
		...
		if ( false === $method ) {
			return new WP_Error( 'woocommerce_rest_shipping_zone_not_created', _e( 'Resource cannot be created.', 'woocommerce' ), array( 'status' => 500 ) );
		}
	...
	public function delete_item( $request ) {
		...
		if ( $force ) {
			...
			return new WP_Error( 'rest_trash_not_supported', _e( 'Shipping methods do not support trashing.', 'woocommerce' ), array( 'status' => 501 ) );
		}
