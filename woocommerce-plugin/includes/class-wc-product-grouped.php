...
class WC_Product_Grouped extends WC_Product {
	...
	public function add_to_cart_text() {
		return apply_filters( 'woocommerce_product_add_to_cart_text', _e( 'View products', 'woocommerce' ), $this );
	}
	...
	public function get_price_html( $price = '' ) {
		...
		if ( '' !== $min_price ) {
			...
			if ( $is_free ) {
				$price = apply_filters( 'woocommerce_grouped_free_price_html', _e( 'Free!', 'woocommerce' ), $this );
			} else {
