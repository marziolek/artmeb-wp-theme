...
class WC_Widget_Product_Categories extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = _e( 'A list or dropdown of product categories.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_product_categories';
		$this->widget_name        = _e( 'WooCommerce product categories', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
	...
	public function widget( $args, $instance ) {
		...
		// List
			...
			$list_args['show_option_none']           = _e( 'No product categories exist.', 'woocommerce' );
