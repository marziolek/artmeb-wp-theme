...
class WC_Widget_Top_Rated_Products extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = _e( 'Display a list of your top rated products on your site.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_top_rated_products';
		$this->widget_name        = _e( 'WooCommerce top rated products', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
