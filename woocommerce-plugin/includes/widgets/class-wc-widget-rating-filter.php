...
class WC_Widget_Rating_Filter extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = _e( 'Filter products by rating when viewing product archives and categories.', 'woocommerce' );
		$this->widget_id          = 'woocommerce_rating_filter';
		$this->widget_name        = _e( 'WooCommerce average rating filter', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
